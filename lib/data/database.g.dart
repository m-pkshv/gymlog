...
class $UserProfileTableTable extends UserProfileTable
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'UserProfileTable';
  @override
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('avatarPath')) {
      context.handle(
        _avatarPathMeta,
        avatarPath.isAcceptableOrUnknown(data['avatarPath']!, _avatarPathMeta),
      );
    }
    if (data.containsKey('updatedAt')) {
      context.handle(
  ...
  UserProfileRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return UserProfileRow(
      ...
      avatarPath: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}avatarPath'],
      ),
      updatedAt: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}updatedAt'],
...
class UserProfileRow extends DataClass implements Insertable<UserProfileRow> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, nickname, firstName, lastName, avatarPath, updatedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
