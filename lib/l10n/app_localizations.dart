...
abstract class AppLocalizations {
  ...
  /// Label of the per-exercise comment field on an exercise card (S-03/S-13, Stage 11, DM 6.6/6.8, max 1000 chars).
  ///
  /// In en, this message translates to:
  /// **'Comment'**
  ...
  /// Action on the Today tab's active-workout card (S-01) that opens the inProgress workout in the editor.
  ///
  /// In en, this message translates to:
  /// **'Continue'**
